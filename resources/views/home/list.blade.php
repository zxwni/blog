...
@section('info')
    <title>{{$field->cate_name}}-陈华个人博客</title>
    <meta name="keywords" content="{{$field->cate_keyword}}" />
    <meta name="description" content="{{$field->cate_description}}" />
@endsection
@section('content')
    <article class="blogs">
        <h1 class="t_nav"><span>{{$field->cate_title}}</span><a href="{{url('/')}}" class="n1">网站首页</a><a href="{{'/cate/'.$field->cate_id.''}}" class="n2">{{$field->cate_name}}</a></h1>
